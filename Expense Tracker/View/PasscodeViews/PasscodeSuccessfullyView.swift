...
private final class PasscodeSuccessfullyDrawing : NSObject {
    public class func drawPasscodeSuccesfullDrawing(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 361, height: 296), resizing: ResizingBehavior = .aspectFit) {
